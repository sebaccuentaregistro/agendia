...
export function AppShell({ children }: { children: ReactNode }) {
    ...
    if (user) {
        if (!userProfile) {
            return <ErrorShell 
                title="Error Crítico del Perfil"
                description="Tu usuario está autenticado, pero no hemos podido encontrar tu perfil en la base de datos. Esto puede ser un problema temporal o de configuración."
            >
        ...
        if (userProfile.status === 'active' && instituteId && !isPublicRoute) {
             return (
