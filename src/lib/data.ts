...
export const people: Person[] = [
  // ~11 months ago
  { id: 'stu-1', name: 'Sophia Loren', phone: '555-0101', joinDate: daysAgo(340), membershipType: 'Mensual', lastPaymentDate: daysAgo(25), avatar: `https://placehold.co/100x100.png`, healthInfo: 'Lesión lumbar crónica. Evitar torsiones profundas.', status: 'active' },
  // ~9 months ago
  { id: 'stu-2', name: 'Liam Gallagher', phone: '555-0102', joinDate: daysAgo(275), membershipType: 'Mensual', lastPaymentDate: daysAgo(15), avatar: `https://placehold.co/100x100.png`, healthInfo: 'Hipertensión. Controlar la intensidad.', status: 'active' },
  { id: 'stu-3', name: 'Chloe Kim', phone: '555-0103', joinDate: daysAgo(270), membershipType: 'Diario', lastPaymentDate: daysAgo(5), avatar: `https://placehold.co/100x100.png`, status: 'active' },
  // ~8 months ago
  { id: 'stu-4', name: 'Benjamin Carter', phone: '555-0104', joinDate: daysAgo(245), membershipType: 'Mensual', lastPaymentDate: daysAgo(10), avatar: `https://placehold.co/100x100.png`, status: 'active' },
  // ~6 months ago
  { id: 'stu-5', name: 'Olivia Martinez', phone: '555-0105', joinDate: daysAgo(185), membershipType: 'Diario', lastPaymentDate: daysAgo(2), avatar: `https://placehold.co/100x100.png`, healthInfo: 'Embarazo de 5 meses. Adaptar posturas.', status: 'active' },
  // ~5 months ago
  { id: 'stu-6', name: 'Noah Rodriguez', phone: '555-0106', joinDate: daysAgo(155), membershipType: 'Mensual', lastPaymentDate: daysAgo(29), avatar: `https://placehold.co/100x100.png`, status: 'active' },
  { id: 'stu-7', name: 'Ava Wilson', phone: '555-0107', joinDate: daysAgo(150), membershipType: 'Mensual', lastPaymentDate: daysAgo(20), avatar: `https://placehold.co/100x100.png`, status: 'active' },
  ...
  // ~4 months ago
  { id: 'stu-9', name: 'Isabella Garcia', phone: '555-0109', joinDate: daysAgo(125), membershipType: 'Mensual', lastPaymentDate: daysAgo(5), avatar: `https://placehold.co/100x100.png`, status: 'active' },
  ...
  // ~3 months ago
  { id: 'stu-11', name: 'Emma Brown', phone: '555-0111', joinDate: daysAgo(95), membershipType: 'Diario', lastPaymentDate: daysAgo(1), avatar: `https://placehold.co/100x100.png`, status: 'active' },
  // ~2 months ago
  { id: 'stu-12', name: 'Lucas Williams', phone: '555-0112', joinDate: daysAgo(65), membershipType: 'Mensual', lastPaymentDate: daysAgo(12), avatar: `https://placehold.co/100x100.png`, status: 'active' },
  ...
  { id: 'stu-15', name: 'Evelyn Miller', phone: '555-0115', joinDate: daysAgo(50), membershipType: 'Mensual', lastPaymentDate: daysAgo(28), avatar: `https://placehold.co/100x100.png`, status: 'active' },
  // ~1 month ago
  { id: 'stu-16', name: 'Logan Wilson', phone: '555-0116', joinDate: daysAgo(35), membershipType: 'Mensual', lastPaymentDate: daysAgo(4), avatar: `https://placehold.co/100x100.png`, status: 'active' },
